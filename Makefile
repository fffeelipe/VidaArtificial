#############################################################################
# Makefile for building: Proyecto_VidaArtificial
# Generated by qmake (3.1) (Qt 5.12.3)
# Project:  Proyecto_VidaArtificial.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Proyecto_VidaArtificial.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Proyecto_VidaArtificial1.0.0
DISTDIR = /home/fffeelipe/Documents/UNAL/Vida\ Artificial/Proyecto_VidaArtificial/.tmp/Proyecto_VidaArtificial1.0.0
LINK          = g++
LFLAGS        = 
...
Proyecto_VidaArtificial:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Proyecto_VidaArtificial.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		Proyecto_VidaArtificial.pro
	$(QMAKE) -o Makefile Proyecto_VidaArtificial.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
all: Makefile Proyecto_VidaArtificial
